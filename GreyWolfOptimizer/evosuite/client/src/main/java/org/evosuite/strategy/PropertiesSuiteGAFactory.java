...
import org.evosuite.ga.metaheuristics.GreyWolfAlgorithm;
...
//				return new MOSA(factory);
	    ...
	    case GWO:
    		logger.info("########## FACTORY SELECTED GWO ##########");
    		System.err.println("########## FACTORY SELECTED GWO ##########");
    		System.err.flush();
	
    		GreyWolfAlgorithm gwo = new GreyWolfAlgorithm(factory);

    		System.err.println("########## GWO OBJECT CREATED: "
            		+ gwo.getClass().getName()
          		+ " ##########");
    		System.err.flush();
