...
public class DefUsePool {
    ...
    private static final Map<String, Map<String, Map<String, List<Definition>>>> defMap = new HashMap<>();

    // className -> methodName -> DUVarName -> List of Uses in that method for
    // the variable
    private static final Map<String, Map<String, Map<String, List<Use>>>> useMap = new HashMap<>();
    // maps IDs to objects
    private static final Map<Integer, DefUse> defuseIdsToDefUses = new HashMap<>();
    ...
    private static final Map<BytecodeInstruction, Integer> registeredDefs = new HashMap<>();
    private static final Map<BytecodeInstruction, Integer> registeredUses = new HashMap<>();
    // an extra one to keep track of parameterUses
    private static final List<BytecodeInstruction> knownParameterUses = new ArrayList<>();
    // and an extra one to keep track of field method calls
    private static final List<BytecodeInstruction> knownFieldMethodCalls = new ArrayList<>();
